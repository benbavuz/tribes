...
ActiveRecord::Schema.define(version: 20170307142748) do
  ...
  create_table "bookings", force: :cascade do |t|
    t.integer  "availabilitie_id"
    t.integer  "hut_id"
    t.integer  "user_id"
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
    t.index ["availabilitie_id"], name: "index_bookings_on_availabilitie_id", using: :btree
  ...
  add_foreign_key "bookings", "availabilities", column: "availabilitie_id"
